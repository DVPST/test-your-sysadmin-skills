...
<details>
<summary><b>Каждая команда завершается ошибкой с <code>команда не найдена</code>. Как отследить источник ошибки и устранить ее?</b></summary><br>
...
<details>
<summary><b>Вы набираете <code>CTRL + C</code>, но ваш скрипт все еще запущен. Как вы его останавливаете? ***</b></summary><br>
